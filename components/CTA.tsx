export default function CTA() {
  ...
  return (
    <footer id="contato" className="relative py-24 bg-brown-800 overflow-hidden" role="contentinfo">
      {/* Organic background */}
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-brown-700/30 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-brown-900/40 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <h2 className="font-display text-5xl md:text-6xl text-cream-100 mb-6 font-semibold">
          Vamos{" "}
